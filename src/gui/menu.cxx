...
////    Simdunas::get_evt_handler()->add_hook(btn_comecar->get_click_event(MouseButton::one()), start_game, this);
//
//    hide_tela_principal();
}
...
//    }
//
////    men->loading_screen = new LoadingScreen();
////    men->loading_screen->show_screen();
//
//    Simdunas::set_play_clicked(true);
//
//}
//
//LoadingScreen* Menu::get_loading_screen() {

...
void Menu::set_textura2(const Event*, void *data) {
...
void Menu::set_textura3(const Event*, void *data) {
...
void Menu::set_textura4(const Event*, void *data) {
...
void Menu::mudar_marcador(float a,float b,float c,void *data){
 Menu * config = (Menu*) data;
...
void Menu::mudar_marcador2(float a,float b,float c,void *data){
 Menu * config = (Menu*) data;
...
void Menu::print_null(void *data) { 
        Menu * config = (Menu*) data;
...
void Menu::swap_texture(void *data) {//recarregar a textura personalizada do lagarto
                Menu *config = (Menu*) data;

...
void GameStatusBar::make_life_bar(NodePath menu_frame_np) {
	...
	img_life_bar.set_pos(0.22, 0.0, 1.46);
	...
	border_life_bar.set_pos(0.22, 0.0, 1.46);
...
void GameStatusBar::make_label_life(NodePath menu_frame_np) {
	...
	np_label_life.set_pos(0.14, 0.0, 1.445);
...
void GameStatusBar::make_piscar_model(NodePath menu_frame_np) {
	...
	piscar_model.set_pos(0.80, 0.0, 0.44);
...
void GameStatusBar::make_hidratacao_bar(NodePath menu_frame_np) {
	...
	img_hidratacao_bar.set_pos(0.10, 0.0, 1.20);
	...
	//hidratacaoBar.set_scale(1.3);
	//hidratacaoBar.set_pos(18.0, 0.0, -6.0);
	...
	np_label_hidratacao.set_pos(0.16, 0.0, 1.17);
...
void GameStatusBar::make_temperatura_bar(NodePath menu_frame_np) {
	...
	img_temperatura_bar.set_pos(0.10, 0.0, 1.0);
	...
	np_label_temperatura.set_pos(0.16, 0.0,0.97);
...
void GameStatusBar::make_temperatura_ambiente_bar(NodePath menu_frame_np) {
	...
	img_temperatura_ambiente_bar.set_pos(0.10, 0.0, 0.8);
	...
	temperatura_ambiente_bar.set_pos(0.28, 0.0, 0.74);
	...
	np_label_temperatura_ambiente.set_pos(0.16, 0.0, 0.77);
...
void GameStatusBar::make_umidade_bar(NodePath menu_frame_np) {
	...
	img_umidade_bar.set_pos(0.10, 0.0, 0.6);
	...
	np_label_umidade.set_pos(0.16, 0.0, 0.57);
...
void GameStatusBar::make_estado_reprodutivo(NodePath menu_frame_np) {
	...
	estado_reprodutivo.set_scale(0.008);
	estado_reprodutivo.set_pos(0.10, 0.0, 0.36);
	...
	np_label_egg_count.set_pos(0.35, 0.0, 0.30);
...
void GameStatusBar::make_idade(NodePath menu_frame_np) {
	...
	label_idade->set_text("Idade");

	np_label_idade = menu_frame_np.attach_new_node(label_idade);
	np_label_idade.set_pos(0.30, 0.0, 1.40);
	...
	np_label_idade_numero.set_pos(0.35, 0.0, 1.35);
